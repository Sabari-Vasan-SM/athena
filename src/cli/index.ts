...
export function buildProgram(): Command {
  ...
  program
    ...
    .option('--agents <list>', 'Agents to configure: comma-separated ids (claude-code, cursor, codex, copilot, gemini-cli, antigravity, agents-md), "all" or "none". Default: detected agents + AGENTS.md')
  ...
  agents.command('add <agents...>').description('Configure integrations (claude-code, cursor, codex, copilot, gemini-cli, antigravity, agents-md, or "all")').action(run(async (names: string[], _o: unknown, cmd: Command) => agentsAddCommand(names, globals(cmd))));
